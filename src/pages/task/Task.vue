    ...
    <div class="container_top mb_15">
      ...
      <div>
        <el-form label-width="80px" :model="form" ref="formRef" size="small">
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="条线" prop="sprintName">
                <el-input
            ...
            <el-col :span="6">
              <el-form-item label="需求" prop="quarter">
                <el-select
            ...
            <el-col :span="6">
              <el-form-item label="需求状态" prop="quarter">
                <el-select
                  v-model="form.quarter"
                  placeholder="请选择需求状态"
                  clearable
            ...
            <el-col :span="6">
              <el-form-item label="冲刺" prop="quarter">
                <el-select
                  v-model="form.quarter"
                  placeholder="请选择需求状态"
                  clearable
            ...
            <el-col :span="6">
              <el-form-item label="开发者" prop="quarter" class="no-item-style">
                <el-select
                  v-model="form.quarter"
                  placeholder="请选择开发者"
                  clearable
    ...
    <div class="container_bottom">
      ...
      >
        <template v-slot:tableColumn>
          <el-table-column label="条线" prop="sprintName" fixed="left">
          ...
          <el-table-column label="需求" prop="quarter" fixed="left" />
          <el-table-column label="任务名" prop="quarter" fixed="left" />
          <el-table-column label="用户故事" prop="quarter" />
          <el-table-column label="任务详细描述" prop="quarter" width="120" />
          <el-table-column label="开发者" prop="quarter" />
          <el-table-column label="工作量" prop="quarter" />
          <el-table-column label="状态" prop="quarter" />
          <el-table-column label="冲刺" prop="quarter" />
          <el-table-column label="优先级" prop="quarter" />
          <el-table-column label="DUE" prop="quarter" />
          <el-table-column label="备注" prop="quarter" />
