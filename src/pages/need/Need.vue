    ...
    <div class="container_bottom">
      ...
      >
        <template v-slot:tableColumn>
          <el-table-column label="归属条线" prop="sprintName">
          ...
          <el-table-column label="需求名" prop="quarter" />
          ...
          <el-table-column label="操作" width="180">
            <template #default="scope">
              ...
              <el-button link @click="del(scope.row)" type="primary"
                >删除</el-button
              >
              <el-button link @click="addTask(scope.row)" type="primary"
                >新建任务</el-button
              >
            </template>
          </el-table-column>
...
import { TASK } from "@/constants/routerUrl";
// useRouter 全局路由对象
...
const handlePge = () => {
  ...
  let path: string = urlEncode(TASK, params);
  router.push(path);
};
const addTask = () => {};
